...
<Callout type="tip">
Use `O` to preview the exact prompt being sent to your AI agent. Press `a` to switch the agent or model for the next iteration. Press `T` to see the subagent tree - this shows what autonomous subtasks the AI is spawning to complete your work.
</Callout>
